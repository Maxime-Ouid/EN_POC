import { TableCard, RowName, RowMenu } from '../components/Table';
import { Pill, Tag, type PillKind } from '../components/Badge';
  ...
  return (
    <section className="screen is-active">
      ...
      <ButtonRow style={{ margin: '18px 0' }}>
        <TopbarSearch placeholder="Rechercher…" onChange={onSearch} />
        <Button size="sm">
          <svg className="icon">
            <use href="#i-filter" />
          </svg>
